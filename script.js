...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 4, 2, 9],
      $isFuture: 1,
      static: {
    ...
    printConsole: [function(e) {
      e.preventDefault();
      H.printString(C.JSString_methods.$add("Url clicked was ", $.link.getAttribute("href")));
    }, "call$1", "link__printConsole$closure", 4, 0, 5]
  }], ["", "script.dart",, N, {
    "^": "",
    main: function() {
      var t1, t2;
